...
tGui.AddButton('x+m yp-3','Preferences').OnEvent('click',(*) => (tGui.Hide(),sleep( 100),pGui.Show(),ControlChooseString(sel, pGui['Tmp'], pGui)))
tGui.AddButton('x+m+150','Exit').OnEvent('click',(*)=>ExitApp())
...
tray.Add('Show Check List`t' HKToString(pGui.oldHK),(*)=>tGui.Show())
tray.Default := 'Show Check List`t' HKToString(pGui.oldHK)
tray.Add('Preference',(*)=>(tGui.Hide(),pGui.Show()))
tray.Add()
